...
from PhysicsTools.BParkingNano.mvaElectronID_BParkRetrain_cff import mvaEleID_BParkRetrain_producer_config
...
#from PhysicsTools.BParkingNano.ElectronMVAValueMapProducer_cfi import electronMVAValueMapProducer
#from RecoEgamma.ElectronIdentification.egmGsfElectronIDs_cfi import egmGsfElectronIDs
      ...
      eleRegs = cms.PSet(
        ...
        epComb = cms.PSet(
            ecalTrkRegressionConfig = cms.PSet(
                rangeMin = cms.double(0.2),
                rangeMax = cms.double(2.0),
                lowEtHighEtBoundary = cms.double(20.),
...
#  lowptSrc = cms.InputTag(''),
 ...
 # unbiasedSeeding = cms.InputTag("lowPtGsfElectronSeedValueMaps","unbiased","RECO"),
  ...
  pfmvaId = cms.InputTag("electronMVAValueMapProducer:ElectronMVAEstimatorRun2BParkRetrainRawValues"),#electronMVAValueMapProducer:ElectronMVAEstimatorRun2BParkRetrainRawValues
...
electronBParkTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
 ...
 cut = cms.string(""),
    ...
    variables = cms.PSet(P4Vars,
        ...
        energySC = Var("superCluster().energy()",float,doc="supercluster energy",precision=10),
